        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <form class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Ex: Ordinateur Portable, Chaise...">
                </div>

                <!-- Prix -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Prix (FCFA)</label>
                    <input type="number" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Ex: 750000">
                </div>

                <!-- Quantité en stock -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Quantité en stock</label>
                    <input type="number" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Ex: 10">
                </div>
